...
legs = [
    ("squeeze_ASIA", "XAU-062", (2.5,11.5), 4.0, 8.0),  # v2: the $29-risk config, best single-leg net
    ("emastack_LONDON", "XAU-005", (11.5,15.5), 1.5, 2.0),
    ("fvg_NY", "XAU-092", (17.5,21.5), 0.5, 1.5),
]
